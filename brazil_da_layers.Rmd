...
precip <- raster("C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/PPTJaman.tif")
...
### Save raster to reproject in gdal
writeRaster(precip_resample,
            filename = "C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/ppt_jaman_resamp.tiff",
            format = "GTiff",
            overwrite = TRUE)
...
soil <- raster("C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/SMJaman.tif")
...
writeRaster(soil_resample,
            filename = "C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/sm_jaman_resamp.tiff",
            format = "GTiff",
            overwrite = TRUE)
...
ppt <- raster("C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/ppt_jaman_102033.tif")
prot_status <- raster("D:/dinamica/brazil_simple/data/bra_prot_status.tif")
soil <- raster("C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/sm_jaman_102033.tif")
...
writeRaster(brick_layers, 
            filename = "D:/dinamica/brazil_simple/data/brazil_static_vars_2.tif", 
            format = "GTiff",
            overwrite = TRUE, 
...
#### Redo for precip and soil moisture
```{r}
### Open resampled and projected precip and soil
jm_precip <- raster("C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/ppt_jaman_102033.tif")
jm_soil <- raster("C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/sm_jaman_102033.tif")

### Open brick with all variables, plus % different neighboring pixels
bra_all <- brick("C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/analyses_paper/bra18_all_data_w_perc_diff.tif")

### Name layers
names(bra_all) <- c("aspect", "mines", 
                    "roads", "rivers", 
                    "cities", "elev", 
                    "popdens", "poverty", 
                    "ppt", "prot_status", 
...
### Drop precip and soil
bra_all <- dropLayer(bra_all, c(9, 12))

### Add soil to brick
bra_all <- addLayer(bra_all, jm_soil)

### Precip is highly correlated anyway, so drop it since can't get extents to match

### Back to brick
bra_all <- brick(bra_all)

### Write out brick
writeRaster(bra_all, 
            filename = "C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/new_dinamica_layers/brazil/discourse_analysis_final_layers/brazil_da_vars_soil.tif", 
            format = "GTiff",
            overwrite = TRUE, 
            options = c("INTERLEAVE=BAND","COMPRESS=LZW"))
