...
#### Open layers
aspect <- raster(raster_list[1])
crop_suit <- raster(raster_list[2])
cities <- raster(raster_list[3])
mines <- raster(raster_list[4])
rivers <- raster(raster_list[6])
roads <- raster(raster_list[7])
popdens <- raster(raster_list[8])
poverty <- raster(raster_list[10])
ppt <- raster(raster_list[11])
prot_status <- raster(raster_list[12])
soil <- raster(raster_list[13])
elev <- raster(raster_list[16])
slope <- raster(raster_list[17])
