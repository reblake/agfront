...
### Adjusted pseudo R2
blr_rsq_mcfadden_adj(fit_per)
blr_rsq_mcfadden_adj(fit_per_2)
blr_rsq_mcfadden_adj(fit_per_3)
blr_rsq_mcfadden_adj(fit_per_4)
...
# 
# ### Open PP1 map
# pp_peru_mask <- raster("/nfs/agfrontiers-data/luc_model/peru_pp_m1_masked_2018.tif")
# 
# ### Vector for area converted from forest to ag
# area_vec <- rep("", times = 1000)
# 
...
#   ### Save raster
#   writeRaster(j_classified,
#               filename = paste0("/nfs/agfrontiers-data/luc_model/peru_1_project_2018/peru_projected_2018_",
#                                 i, ".tif"),
#               format = "GTiff",
#               overwrite = TRUE,
#               options = c("INTERLEAVE=BAND","COMPRESS=LZW"))
...
# ### Save vector of area lost
# write.csv(area_vec,
#           file = "/nfs/agfrontiers-data/luc_model/peru_1_project_2018/peru_projected_loss_2018.csv",
#           row.names=FALSE)
# write.csv(tambo_area_vec,
#           file = "/nfs/agfrontiers-data/luc_model/peru_1_project_2018/peru_projected_loss_tambopata_2018.csv",
#           row.names=FALSE)
# write.csv(bahua_area_vec,
#           file = "/nfs/agfrontiers-data/luc_model/peru_1_project_2018/peru_projected_loss_bahuaja_2018.csv",
#           row.names=FALSE)
# 
# ######################
# ### Model 2 projection
# ######################
# ### Open PP2 map
# pp2_peru_mask <- raster("/nfs/agfrontiers-data/luc_model/peru_pp_m2_masked_2018.tif")
# 
# ### Vector for area converted from forest to ag
# area_vec <- rep("", times = 1000)
# 
...
#   ### Save raster
#   writeRaster(j_classified,
#               filename = paste0("/nfs/agfrontiers-data/luc_model/peru_2_project_2018/peru_2_projected_2018_",
#                                 i, ".tif"),
#               format = "GTiff",
#               overwrite = TRUE,
#               options = c("INTERLEAVE=BAND","COMPRESS=LZW"))
...
# ### Save vector of area lost
# write.csv(area_vec,
#           file = "/nfs/agfrontiers-data/luc_model/peru_2_project_2018/peru_2_projected_loss_2018.csv",
#           row.names=FALSE)
# write.csv(tambo_area_vec,
#           file = "/nfs/agfrontiers-data/luc_model/peru_2_project_2018/peru_2_projected_loss_tambopata_2018.csv",
#           row.names=FALSE)
# write.csv(bahua_area_vec,
#           file = "/nfs/agfrontiers-data/luc_model/peru_2_project_2018/peru_2_projected_loss_bahuaja_2018.csv",
#           row.names=FALSE)
# 
# ######################
# ### Model 3 projection
# ######################
# ### Open PP3 map
# pp3_peru_mask <- raster("/nfs/agfrontiers-data/luc_model/peru_pp_m3_masked_2018.tif")
# 
# ### Vector for area converted from forest to ag
# area_vec <- rep("", times = 1000)
# 
...
#   ### Save raster
#   writeRaster(j_classified,
#               filename = paste0("/nfs/agfrontiers-data/luc_model/peru_3_project_2018/peru_3_projected_2018_",
#                                 i, ".tif"),
#               format = "GTiff",
#               overwrite = TRUE,
#               options = c("INTERLEAVE=BAND","COMPRESS=LZW"))
...
# ### Save vector of area lost
# write.csv(area_vec,
#           file = "/nfs/agfrontiers-data/luc_model/peru_3_project_2018/peru_3_projected_loss_2018.csv",
#           row.names=FALSE)
# write.csv(tambo_area_vec,
#           file = "/nfs/agfrontiers-data/luc_model/peru_3_project_2018/peru_3_projected_loss_tambopata_2018.csv",
#           row.names=FALSE)
# write.csv(bahua_area_vec,
#           file = "/nfs/agfrontiers-data/luc_model/peru_3_project_2018/peru_3_projected_loss_bahuaja_2018.csv",
#           row.names=FALSE)
# 
# ######################
# ### Model 4 projection
# ######################
# ### Open PP4 map
# pp4_peru_mask <- raster("/nfs/agfrontiers-data/luc_model/peru_pp_m4_masked_2018.tif")
# 
# ### Vector for area converted from forest to ag
# area_vec <- rep("", times = 1000)
# 
...
#   ### Save raster
#   writeRaster(j_classified,
#               filename = paste0("/nfs/agfrontiers-data/luc_model/peru_4_project_2018/peru_4_projected_2018_",
#                                 i, ".tif"),
#               format = "GTiff",
#               overwrite = TRUE,
#               options = c("INTERLEAVE=BAND","COMPRESS=LZW"))
...
# ### Save vector of area lost
# write.csv(area_vec,
#           file = "/nfs/agfrontiers-data/luc_model/peru_4_project_2018/peru_4_projected_loss_2018.csv",
#           row.names=FALSE)
# write.csv(tambo_area_vec,
#           file = "/nfs/agfrontiers-data/luc_model/peru_4_project_2018/peru_4_projected_loss_tambopata_2018.csv",
#           row.names=FALSE)
# write.csv(bahua_area_vec,
#           file = "/nfs/agfrontiers-data/luc_model/peru_4_project_2018/peru_4_projected_loss_bahuaja_2018.csv",
#           row.names=FALSE)
#
...
###################
### Try on subset of layers in Peru Model 1
test_layers <- list.files(path = "/nfs/agfrontiers-data/luc_model/peru_1_project_2018",
                          pattern = "*.tif",
                          full.names = TRUE)
...
### Write out sum raster
writeRaster(raster_fill,
            filename = "/nfs/agfrontiers-data/luc_model/peru_m1_2018_stacked_5.tif",
            format = "GTiff",
            overwrite = TRUE,
            options = c("INTERLEAVE=BAND","COMPRESS=LZW"))
...
###################
### Try on subset of layers in Peru Model 2
test_layers <- list.files(path = "/nfs/agfrontiers-data/luc_model/peru_2_project_2018",
                          pattern = "*.tif",
                          full.names = TRUE)
...
### Write out sum raster
writeRaster(raster_fill,
            filename = "/nfs/agfrontiers-data/luc_model/peru_m2_2018_stacked_5.tif",
            format = "GTiff",
            overwrite = TRUE,
            options = c("INTERLEAVE=BAND","COMPRESS=LZW"))
...
###################
### Try on subset of layers in Peru Model 3
test_layers <- list.files(path = "/nfs/agfrontiers-data/luc_model/peru_3_project_2018",
                          pattern = "*.tif",
                          full.names = TRUE)
...
### Write out sum raster
writeRaster(raster_fill,
            filename = "/nfs/agfrontiers-data/luc_model/peru_m3_2018_stacked_5.tif",
            format = "GTiff",
            overwrite = TRUE,
            options = c("INTERLEAVE=BAND","COMPRESS=LZW"))
...
###################
### Try on subset of layers in Peru Model 4
test_layers <- list.files(path = "/nfs/agfrontiers-data/luc_model/peru_4_project_2018",
                          pattern = "*.tif",
                          full.names = TRUE)
...
### Write out sum raster
writeRaster(raster_fill,
            filename = "/nfs/agfrontiers-data/luc_model/peru_m4_2018_stacked_5.tif",
            format = "GTiff",
            overwrite = TRUE,
            options = c("INTERLEAVE=BAND","COMPRESS=LZW"))