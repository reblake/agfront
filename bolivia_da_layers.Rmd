...
mines <- raster(raster_list[2])
roads <- raster(raster_list[3])
rivers <- raster(raster_list[4])
cities <- raster(raster_list[5])
elev <- raster(raster_list[6])
popdens <- raster(raster_list[7])
poverty <- raster(raster_list[8])
ppt <- raster(raster_list[9])
prot_status <- raster(raster_list[10])
slope <- raster(raster_list[11])
soil <- raster(raster_list[12])
crop_suit <- raster(raster_list[15])
