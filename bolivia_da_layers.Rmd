...
## North-South Line
Tablas Monte to El Torno
```{r}
### Open raster
south_rast <- raster("C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/new_dinamica_layers/bolivia/bol_south.tif")

### Open shapefile of actual dividing line
south_shp <- st_read("C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/new_dinamica_layers/bolivia/bol_south_section.shp")

### Crop raster to shp
south_rast <- mask(south_rast, south_shp)

### Resample to match other rasters
south_rast_resamp <- raster::resample(south_rast,
                                      ambcar_rast,
                                      "ngb")

### NA to 0
south_rast_resamp[is.na(south_rast_resamp)] <- 1

### 0 = Southern section
### 1 = Northern section

### Open buffer
ac_buff <- st_read("C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/case_study_shp/AmbCar/ambcar_buffer_updated.shp")

### Crop raster to shp
south_rast_resamp <- mask(south_rast_resamp,
                          ac_buff)

### write out
writeRaster(south_rast_resamp,
            "C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/new_dinamica_layers/bolivia/bol_south_north.tif")
```
...
### Fix invalid geoms in shapefiles
```{r}
### Open file
file1 <- st_read("E:/bol_landtenure/INRA_2_1/tierra_fiscal_2013.shp")

### Fix invalid geoms
file1 <- st_make_valid(file1)

### Open buffer
buff <- st_read("C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/case_study_shp/AmbCar/ambcar_4326.shp")
...
### Crop
file1 <- st_intersection(file1, buff)

### Write out
# st_write(file1, 
#          "E:/bol_landtenure/INRA_1/TITULADOS_20_valid.shp")
# st_write(file1, 
#          "E:/bol_landtenure/INRA_2_1/a_Predios_Titulados_20_valid.shp")
# st_write(file1, 
#          "E:/bol_landtenure/INRA_2_1/cochabamba_valid.shp")
# st_write(file1, 
#          "E:/bol_landtenure/INRA_2_1/PANDO_Proceso_valid.shp")
# st_write(file1,
#          "E:/bol_landtenure/INRA_2_1/pred_proces_2013_valid.shp")
# st_write(file1,
#          "E:/bol_landtenure/INRA_2_1/pred_proces_ene_2012_valid.shp")
# st_write(file1,
#          "E:/bol_landtenure/INRA_2_1/PREDIOS_20_valid.shp")
# st_write(file1,
#          "E:/bol_landtenure/INRA_2_1/PROCESO_z20_dicimebre_2014_2_valid.shp")
# st_write(file1,
#          "E:/bol_landtenure/INRA_2_1/PROCESO_z20_dicimebre_2014_3_valid.shp")
# st_write(file1,
#          "E:/bol_landtenure/INRA_2_1/santacruz_valid.shp")
st_write(file1,
         "E:/bol_landtenure/INRA_2_1/tierra_fiscal_2013_valid.shp")

```

## Fix precip
```{r}
### Open raster with enlarged buffer
precip <- raster("C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/new_dinamica_layers/bolivia/ppt_bol_102033.tif")

### Resample
precip_resamp <- raster::resample(precip,
                                  ambcar_rast,
                                  "bilinear")

### Crop raster to shp
precip_resamp <- mask(precip_resamp,
                      ac_buff)

### write out
writeRaster(precip_resamp,
            "C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/new_dinamica_layers/bolivia/bol_precip_use.tif")
```
