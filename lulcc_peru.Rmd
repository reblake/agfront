...
st_write(per_dat_all,
         "D:/dinamica/sample_pts_model/peru_f_data.shp")
```

#### Combine with neighbor pix values
```{r}
### Open brazil_f_data
per_data <- st_read("/nfs/agfrontiers-data/luc_model/per_f_data.shp")
...
### Make corr table
cor_table_per <- flattenSquareMatrix(cor.prob(per_dat_use[, c(2, 3, 7:15, 17:20, 22:28, 30, 31)]))
