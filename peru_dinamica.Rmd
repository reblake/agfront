...
################################  
### Open soil raster
soil <- raster("C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/peru_dinamica/ClassicModel/soil_102033.tif")
...
soil_resample <- raster("C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/peru_dinamica/data/per_soilm.tif")
...
precip_resample <- raster("C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/peru_dinamica/data/per_precip.tif")
...
writeRaster(all_layer_brick, 
            filename = "C:/Users/Katherine Siegel/Documents/SESYNC/dinamica/peru_dinamica/data/peru_all_layers.tif", 
            format = "GTiff",
            overwrite = TRUE, 
            options = c("INTERLEAVE=BAND","COMPRESS=LZW"))
```
